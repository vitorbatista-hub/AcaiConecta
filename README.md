...
- [Referência do protótipo no v0 — ainda não validado](https://v0.app/vitors-projects-edcbface/chat/acaiconecta-jAWnqGHlb8w)
...
- Protótipo: correções do fluxo principal verificadas tecnicamente; cobertura restante do PRD e testes de usabilidade pendentes (ver relatório no README do protótipo)
