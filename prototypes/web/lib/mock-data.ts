...
export const adminActorName='Administrador do piloto'
export const guestCustomerName='Cliente'
...
export const allowedProductVolumesMl=[500,1000] as const
