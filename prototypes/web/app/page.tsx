...
export default function Page() {
  return <main className="min-h-screen bg-background">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <footer className="border-t border-border py-8"><Brand /><p className="mt-3 text-sm text-muted-foreground">Um protótipo de descoberta e pedidos para batedeiras locais em Cametá, PA.</p></footer>
    </div>
  </main>
}
